...
// Ejecutar con: node populate-database-cjs.js
...
const contratosEjemplo = [
  ...
  },
  {
    ...
    fechaTermino: new Date('2027-09-30'),
    monto: 0, // Contrato de comisiones
    moneda: 'USD',
    ...
    estado: EstadoContrato.REVISION,
    organizacionId: 'org-001',
    departamento: 'Ventas',
  ...
  },
  {
    ...
    fechaInicio: new Date('2024-01-15'),
    fechaTermino: new Date('2024-03-31'),
    monto: 18000000,
    moneda: 'CLP',
